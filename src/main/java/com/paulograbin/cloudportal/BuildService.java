...
public class BuildService
{
	...
	public BuildDetailsDTO getAllBuilds()
	{
		...
		BuildDetailsDTO buildDetailsDTO = cloudPortalAPI.sendRequest("builds", BuildDetailsDTO.class);
	...
	public BuildDetailDTO getBuildDetails(String buildCode)
	{
		...
		BuildDetailDTO buildDetailDTO = cloudPortalAPI.sendRequest("builds/" + buildCode, BuildDetailDTO.class);
...
//		createBuildResponse.setCode("20230329.3");
	...
	{
		BuildProgressDTO buildProgress = cloudPortalAPI.getBuildProgress(createBuildResponse.getCode());
